...
mongoose
    .connect(process.env.MONGO_DATABASE_AUT)
    .then(() => console.log('Connected to MongoDB AUT Successfull!'))
    .catch((error) => (console.error(error)))

const port = process.env.PORT
app.listen(port, () => console.log('Server Automation listening on port: ', port))
